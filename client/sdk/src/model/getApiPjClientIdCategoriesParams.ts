 ...
 */
import type { TreeQueryParameter } from './treeQueryParameter';

export type GetApiPjClientIdCategoriesParams = {
/**
 * When set to true returns categories structured as a hierarchy
 */
tree?: TreeQueryParameter;
};
